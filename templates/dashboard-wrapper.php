...
//                echo '<div class="order-summary ' . $status_class . '">';
                ...
                echo '</div>';
                echo '<div class="order-customer">' . $order->get_billing_first_name() . ' ' . $order->get_billing_last_name() . ' - '.$order->get_billing_phone().'</div>';
                ...
                foreach ($order->get_items() as $item) {
                    echo '<div>' . $item->get_name() . ' x' . $item->get_quantity() . ' - סה"כ '.wc_price($item->get_total()).'</div>' ;
                    // show the price next to it
                }
                echo '</div>';
                echo '</div>';
            }
